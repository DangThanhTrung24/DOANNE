...
CREATE TABLE [Discount](
    ...
    [UpdateDay] DATETIME NULL,
    [PersonUpdate] INT NULL,
    FOREIGN KEY ([PersonCreate]) REFERENCES [Users]([Id]),
    FOREIGN KEY ([PersonDelete]) REFERENCES [Users]([Id]),
    FOREIGN KEY ([PersonUpdate]) REFERENCES [Users]([Id])
);
...
-- Tạo bảng Danh sách yêu thích (Favorites)
...
-- Tạo bảng Thông tin cửa hàng (InformationShop)
...
-- Tạo bảng Nhà sản xuất (Manufactures)
...
-- Tạo bảng Danh sách thực đơn (MenuOne)
...
-- Tạo bảng Danh sách thực đơn con (MenuTwo)
...
INSERT INTO Users VALUES
	(N'trungdt@gmail.com', N'123456', N'Đặng Thành Trung', 1, CAST(N'2003-09-24' AS Date), 0, CAST(N'2023-09-20T11:52:28.310' AS DateTime), null, 0),
	(N'loc@gmail.com', N'123456', N'Nguyễn Đại Lộc', 1, CAST(N'2003-06-15' AS Date), 0, CAST(N'2023-09-21T11:52:28.310' AS DateTime), null, 0),
	(N'tan@gmail.com', N'123456', N'Vũ Nhật Tân', 0, CAST(N'2003-09-27' AS Date), 0, CAST(N'2023-09-22T11:52:28.310' AS DateTime), null, 0),
	(N'anh@gmail.com', N'123456', N'Nguyễn Trần Nhật Anh', 1, CAST(N'2003-08-10' AS Date), 0, CAST(N'2023-09-23T11:52:28.310' AS DateTime), null, 0),
	(N'sang@gmail.com', N'123456', N'Nguyễn Quang Sáng', 0, CAST(N'2003-05-1' AS Date), 0, CAST(N'2023-09-24T11:52:28.310' AS DateTime), null, 0),
	(N'no@gmail.com', N'123456', N'Phạm Thị Nở', 0, CAST(N'2003-04-11' AS Date), 0, CAST(N'2023-09-11T11:52:28.310' AS DateTime), null, 0),
	(N'pheo@gmail.com', N'123456', N'Nguyễn Chí Phèo', 1, CAST(N'2000-01-2' AS Date), 0, CAST(N'2023-09-12T11:52:28.310' AS DateTime), null, 0);

INSERT INTO [Address] VALUES
	(N'Đặng Thành Trung', N'0889641810', N'Hồ Chí Minh', N'Tân Bình', N'15', N'600 Phạm Văn Bạch, phường 15, quận Tân Bình, TP.Hồ Chí Minh', 1),
	(N'Nguyễn Đại Lộc', N'0889641811', N'Hồ Chí Minh', N'Gò Vấp', N'14', N'100 Lê Đức Thọ, phường 14, quận Gò Vấp, TP.Hồ Chí Minh', 2),
	(N'Vũ Nhật Tân', N'0889641812', N'Hồ Chí Minh', N'Quận 3', N'2', N'123 Văn Cao, phường 2, quận 3, TP.Hồ Chí Minh', 3),
	(N'Nguyễn Trần Nhật Anh', N'0889641813', N'Hồ Chí Minh', N'Thủ Đức', N'Hiệp Bình Phước', N'123 quốc lộ 13, phường Hiệp Bình Phước, quận Thủ Đức, TP.Hồ Chí Minh', 4),
	(N'Nguyễn Quang Sáng', N'0889641814', N'Hồ Chí Minh', N'Tân Bình', N'P15', N'100 Phạm Văn Bạch, phường 15, quận Tân Bình, TP.Hồ Chí Minh', 5),

	(N'Phạm Thị Nở', N'0889641815', N'Hồ Chí Minh', N'Tân Bình', N'15', N'Tân Sơn, phường 15, quận Tân Bình, TP.Hồ Chí Minh', 6),
	(N'Nguyễn Chí Phèo', N'0889641816', N'Hồ Chí Minh', N'Tân Bình', N'15', N'Nguyễn Phúc Chu, phường 15, quận Tân Bình, TP.Hồ Chí Minh', 7);


INSERT INTO [Categories] VALUES
	(N'Pháp Luật', N'9-20x20.png', N'banner-3.jpg', N'Nơi tự hào là địa chỉ uy tín và chất lượng hàng đầu dành cho những ai đam mê tìm hiểu tra cứu các văn bản  luật, pháp lý và mong muốn tìm kiếm những cuốn sách về lĩnh vực luật - văn bản luật cùng các tác giả nổi tiếng trong lĩnh vực pháp lý.', CAST(N'2021-09-20T19:09:20.993' AS DateTime), 1, NULL, 0, CAST(N'2021-11-12T14:59:21.427' AS DateTime), 1, N'phap-ly'),
	(N'Kinh Tế', N'5-20x20.png', N'az-viet-nam-banner.jpg', N'Nền kinh tế trên toàn thế giới đang bị tác động mạnh mẽ bởi cuộc cách mạng Công nghiệp 4.0. Nhiều khái niệm, định luật, lĩnh vực không còn phù hợp đã bị đào thải nhanh chóng để bắt kịp với sự vận động liên tục của nhân loại.', CAST(N'2022-09-20T19:09:20.993' AS DateTime), 1, NULL, 0, CAST(N'2022-11-12T14:59:21.427' AS DateTime), 1, N'kinh-te'),
	(N'Văn Hóa Xã Hội', N'2-20x20.png', N'banner-3.jpg', N'Khả năng sáng tạo của con người là vô hạn, chúng ta hoàn toàn có thể tạo nên những trải nghiệm cho chính mình bằng sức mạnh niềm tin, của suy nghĩ và cảm xúc. Chúng ta có thể lựa chọn niềm tin và từ đó làm thay đổi thực tế cuộc sống của mình, tạo nên tất cả những gì mà mình hằng mơ ước.', CAST(N'2022-09-21T20:18:06.043' AS DateTime), 1, NULL, 0, CAST(N'2022-10-12T19:56:49.137' AS DateTime), 1, N'van-hoa-xa-hoi'),
	(N'Văn Học Nghệ Thuật', N'6-20x20.png', N'banner-3.jpg', N'Văn học nghệ thuật (còn gọi là văn học tinh hoa) là dòng văn học cao cấp, do tầng lớp tri thức của xã hội sáng tạo nên với nhu cầu được khám phá nội tâm và đời sống tinh thần của con người, giúp người đọc hiểu được những phức cảm tâm lý sâu sắc của con người, như khát vọng được sống, được tự do, hoặc những mặc cảm tội...', CAST(N'2023-09-21T20:19:40.737' AS DateTime), 1, NULL, 0, CAST(N'2023-10-12T19:57:36.573' AS DateTime), 1, N'van-hoc-nghe-thuat'),
	(N'Giáo Trình', N'11-20x20.png', N'banner-3.jpg', N'Giáo trình là hệ thống chương trình giảng dạy của một môn học. Nó là tài liệu học tập hoặc giảng dạy được thiết kế và biên soạn dựa trên cơ sở chương trình môn học. Mục đích để làm tài liệu giảng dạy chính thức cho giáo viên, hoặc / và làm tài liệu học tập chính thức cho học sinh, sinh viên.', CAST(N'2023-07-21T20:22:23.947' AS DateTime), 1, NULL, 0, CAST(N'2023-10-12T19:57:48.607' AS DateTime), 1, N'giao-trinh'),
	(N'Tiểu Thuyết', N'4-20x20.png', N'alpha-book-banner.jpg', N'Tiểu thuyết là một thể loại văn xuôi có hư cấu, thông qua nhân vật, hoàn cảnh, sự việc để phản ánh bức tranh xã hội rộng lớn và những vấn đề của cuộc sống con người, biểu hiện tính chất tường thuật, tính chất kể chuyện bằng ngôn ngữ văn xuôi theo những chủ đề xác định.', CAST(N'2023-08-21T20:24:22.287' AS DateTime), 1, NULL, 0, CAST(N'2023-10-20T22:27:04.633' AS DateTime), 1, N'light-novel'),
	(N'Tâm Linh', N'10-20x20.png', N'banner-3.jpg', N'Sách Tâm Linh là một thể loại sách có liên quan đến tâm lý, tình cảm và hành động của con người. Ngoài ra tìm đọc một cuốn sách tâm linh hay còn giúp cho chúng ta hiểu thêm về bản thân mình và các mối quan hệ xã hội xung quanh. Từ đây giúp chúng ta giải quyết được các vấn đề trong cuộc sống. ', CAST(N'2022-08-22T06:02:54.557' AS DateTime), 1, NULL, 0, CAST(N'2023-09-22T10:01:44.787' AS DateTime), 1, N'tam-linh'),
	(N'Thiếu Nhi', N'10-20x20.png', N'nxb-kim-dong-banner.jpg', N'Một nhà văn viết về văn học thiếu nhi định nghĩa nó là "tất cả các cuốn sách viết cho trẻ em, ngoại trừ các tác phẩm như truyện tranh, truyện cười, sách hoạt hình và các tác phẩm phi hư cấu không được đọc từ trước ra sau, như từ điển, bách khoa toàn thư và các tài liệu tham khảo khác."', CAST(N'2023-08-22T06:03:43.933' AS DateTime), 1, NULL, 0, CAST(N'2023-10-29T22:27:50.997' AS DateTime), 1, N'thieu-nhi')



INSERT INTO [Blogs] VALUES 
/*	(N'Mauro F. Guillén – Người dự báo xu hướng thế giới tương lai', N'<h3>Khái quát sự nghiệp của Mauro F. Guillen</h3>
                                <br>
                                <span>
	...
	N'xu-huong-the-gioi-blog-logo.png', CAST(N'2023-09-20' AS Date), N'xu-huong-the-gioi-blog-banner.png', 1, CAST(N'2023-09-20T08:53:04.853' AS DateTime), 1, NULL, 0, null, 0, N'xu-huong-the-gioi', 
	N'Cuốn sách <b> 2030 Những Xu Hướng Lớn Sẽ Định Hình Thế Giới Tương Lai </b> bày ra cho chúng ta một bức tranh toàn cảnh về sự thay đổi. Thế giới không còn phân chia gọn gàng giữa các nền kinh tế thịnh vượng hay lạc hậu nữa.'),

*/
	(N'Review sách Kinh Doanh Nhỏ, Thu Lợi Lớn', N'<h3>Kinh Doanh Nhỏ, Thu Lợi Lớn </h3>
                                <br>
                                <span>
	...
	N'kinh-doanh-nho-blog-logo.png', CAST(N'2022-12-11' AS Date), N'kinh-doanh-nho-blog-banner.png', 1, CAST(N'2022-12-11T10:09:13.437' AS DateTime), 1, NULL, 0, null, 0, N'kinh-doanh-nho', 
	N'Cuốn sách <b> Kinh Doanh Nhỏ Thu Lợi Lớn </b>-Mọi người luôn tán dương những dự án đầu tư khổng lồ, những thành tích đầy danh tiếng Nhưng ít ai biết được ở những góc phố, những gánh hàng rong cũng tồn tại những tỉ phú thầm lặng.'),


	(N'Review Nghệ Thuật Tinh Tế Của Việc “Đếch” Quan Tâm', N'<h3>Nghệ Thuật Tinh Tế Của Việc “Đếch” Quan Tâm </h3>
                                <br>
                                <span>
	...
	N'dech-quan-tam-blog-logo.png', CAST(N'2022-12-11' AS Date), N'dech-quan-tam-blog-banner.png', 1, CAST(N'2022-12-11T10:09:13.437' AS DateTime), 1, NULL, 0, null, 0, N'dech-quan-tam', 
	N'Mất một quãng thời gian tìm việc không thành công, Mark mặc kệ đời, bỏ tất cả và đi lòng vòng thế giới để hoàn thành việc viết sách về tư vấn tình cảm.'),


	(N'Review Sách Lối Sống Tối Giản Thời Công Nghệ Số', N'<h3>Sách Lối Sống Tối Giản Thời Công Nghệ Số </h3>
                                <br>
                                <span>
	...
	N'loi-song-don-gian-blog-logo.png', CAST(N'2022-12-11' AS Date), N'loi-song-don-gian-blog-banner.png', 1, CAST(N'2022-12-11T10:09:13.437' AS DateTime), 1, NULL, 0, null, 0, N'loi-song-don-gian', 
	N'Cal Newport là Phó giáo sư khoa học máy tính tại Đại học Georgetown đồng thời cũng là tác giả trẻ với 6 cuốn sách được nhiều độc giả yêu thích.'),



	(N'Review sách Tôi Là Zlatan Ibrahimovic', N'<h3>Tóm tắt nội dung sách Tôi là Zlatan Ibrahimovic</h3>
                                <br>
                                <span>
	...
	N'zlatan-blog-logo.png', CAST(N'2023-09-20' AS Date), N'zlatan-blog-banner.png', 1, CAST(N'2023-09-20T08:53:04.853' AS DateTime), 1, NULL, 0, null, 0, N'zlatan', 
	N'Zlatan Ibrahimovic (3/10/1981) là một trong những tiền đạo xuât sắc nhất của bóng đá Tên tuổi anh được làm nên qua hàng loạt công trạng tại các câu lạc bộ lớn với lối đá hiệu quả và kỹ năng dứt điểm thượng thừa.'),


	(N'Kevin Mitnick – Tội Phạm hay Người hùng công nghệ?', N'<h3>Kevin Mitnick (6/8/1963)</h3>
                                <br>
                                <span>
	...
	N'kevin-mitnick-blog-logo.png', CAST(N'2023-09-20' AS Date), N'kevin-mitnick-blog-banner.png', 1, CAST(N'2023-09-20T08:53:04.853' AS DateTime), 1, NULL, 0, null, 0, N'nghe-thuat-an-minh', 
	N'Hy vọng bài viết đã phần nào cung cấp được thông tin cho độc giả về câu hỏi Kevin Mitnick là ai?truyền cảm hứng cũng như nhắc nhở chúng ta về việc tự bảo vệ mình trước công nghệ với vô số hacker trong thời đại mới.'),


	(N'Review sách 100 việc nên làm trước tuổi 20', N'<h3>100 việc nên làm trước tuổi 20  </h3>
                                <br>
                                <span>
	...
	N'tuoi20-blog-logo.png', CAST(N'2023-09-21' AS Date), N'tuoi20-blog-banner.png', 1, CAST(N'2023-09-21T08:53:04.853' AS DateTime), 1, NULL, 0, null, 0, N'dech-quan-tam', 
	N'Bạn Tốt là tác giả của những cuốn sách như Xóa bỏ định kiến, Tôi có trí nhớ kém, Nói nhiều không bằng nói đúng, Không phải thiếu may mắn, Chỉ là chưa cố gắng; 99 điều đúc rút từ trí tuệ nhân loại người trẻ cần biết; 100 việc nên làm trước tuổi 20;…'),
