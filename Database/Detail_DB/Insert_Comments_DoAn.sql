...
(N'Sách hay lắm nè', 5, 1, 8, CAST(N'2023-9-25' AS Date), 1),
(N'Chất lượng sản phẩm tuyển vời', 5, 2, 15, CAST(N'2023-9-25' AS Date), 0),
(N'Đóng gói sản phẩm chắc chắn', 5, 3, 17, CAST(N'2023-9-25' AS Date), 1),
(N'Hàng đẹp giá hợp lý', 5, 4, 2, CAST(N'2023-9-25' AS Date), 0),
(N'Mới nhận hàng chưa đọc', 5, 5, 6, CAST(N'2023-9-25' AS Date), 1),
