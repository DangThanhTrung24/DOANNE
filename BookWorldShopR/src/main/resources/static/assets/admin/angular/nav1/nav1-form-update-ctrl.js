...
// kiểm tra tên tìm kiếm đã nhập chưa
...
// nếu chưa chọn đầy đủ sẽ vô heieu hóa nút lưu
...
app.controller("nav1-form-ctrl", function ($scope, $http) {
  ...
  // hiển thị tất cả loại sản phẩm để chọn
  ...
  // load thông tin chi tiết của menu 1
  $scope.load = function () {
    $http
