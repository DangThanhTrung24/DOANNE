...
// nếu kiểm tra chưa xong thì sẽ vô hiệu hóa nút lưu
...
app.controller("manufacturer-form-ctrl", function ($scope, $http) {
  $scope.form = {};
  $scope.info = {};
  // hiển thị thông tin chi tiết khi được chọn
  $scope.load = function () {
    $http
