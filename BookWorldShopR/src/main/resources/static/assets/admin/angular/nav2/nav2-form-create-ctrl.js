...
// nhập tên tìm kiếm của menu2 chưa
...
// kiểm tra tất cả được nhập chưa
function checkForm() {
  $("#nameNav2").keyup();
  $("#menu1").change();
  $("#nameSearch").keyup();
...
// nếu chưa được nhập sẽ vô hiệu hóa nút lưu
...
// hiển thị danh sách menu 1 lên form
