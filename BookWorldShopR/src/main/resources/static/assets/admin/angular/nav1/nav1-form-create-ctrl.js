...
$(document).ready(function () {
	// kiểm tra tên menu 1 đã được nhập chưa
...
// loại danh mục đã được chọn chưa
...
// chưa nhập hết sẽ vô hiệu hóa nút lưu
...
app.controller("nav1-form-ctrl", function ($scope, $http) {
  ...
  // hiển thị tất cả các loại lên form để chọn
